...
public class DentalInsurableCard extends InsurableCard{
    ...
    public DentalInsurableCard(@NonNull Insurable insurable) {
        super(insurable);
    ...
    public String getHeader() {
        ...
        if (insurable != null) {
            ...
            if(header == null){
                return "Dental:" + getInsurable().getSpecificData(priorityTitles[0]);
            }
        }
        return header;
    }
